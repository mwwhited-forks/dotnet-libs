    ...
    public class LessonService : ILessonService
    {
        ...
        public LessonService(IOptions<LessonDatabaseSettings> lessonDatabaseSettings)
        {
            ...
            _lessonsCollection = mongoDatabase.GetCollection<LessonCollection>(
                lessonDatabaseSettings.Value.VlogsCollectionName);
        ...
        public async Task<LessonModel> CreateAsync(LessonModel newVlog)
        {
            LessonCollection vlog = _lessonCollectionBuilder.BuildCollection(newVlog);
            await _lessonsCollection.InsertOneAsync(vlog);
            newVlog.LessonId = vlog.LessonId;
            return newVlog;
        }

        public async Task UpdateAsync(LessonModel updatedVlog) =>
            await _lessonsCollection.ReplaceOneAsync(x => x.LessonId == updatedVlog.LessonId, _lessonCollectionBuilder.BuildCollection(updatedVlog));
