...
/// <summary>
///     A convention that configures the default model <see cref="QdrantValueGenerationStrategy" /> as
///     <see cref="QdrantValueGenerationStrategy.IdentityColumn" />.
/// </summary>
/// <remarks>
...
/// </remarks>
public class QdrantValueGenerationStrategyConvention : IModelInitializedConvention, IModelFinalizingConvention
{
    /// <summary>
    ///     Creates a new instance of <see cref="QdrantValueGenerationStrategyConvention" />.
    /// </summary>
    /// <param name="dependencies">Parameter object containing dependencies for this convention.</param>
    /// <param name="relationalDependencies"> Parameter object containing relational dependencies for this convention.</param>
    public QdrantValueGenerationStrategyConvention(
    ...
    public virtual void ProcessModelInitialized(
        ...
        => modelBuilder.HasValueGenerationStrategy(QdrantValueGenerationStrategy.IdentityColumn);
        ...
        IConventionContext<IConventionModelBuilder> context)
    {
        foreach (var entityType in modelBuilder.Metadata.GetEntityTypes())
        {
            foreach (var property in entityType.GetDeclaredProperties())
            {
                    ...
                    && declaringTable.Name != null)
                {
                    ...
                    if (strategy == QdrantValueGenerationStrategy.Sequence)
                    {
        ...
        bool IsStrategyNoneNeeded(IReadOnlyProperty property, StoreObjectIdentifier storeObject)
        {
            if (property.ValueGenerated == ValueGenerated.OnAdd
                ...
                && property.DeclaringType.Model.GetValueGenerationStrategy() == QdrantValueGenerationStrategy.IdentityColumn)
            {
