...
/// </remarks>
public class QdrantIndexConvention :
    ...
    IPropertyAnnotationChangedConvention
{
    ...
    {
        if (name == QdrantAnnotationNames.Clustered)
        {
            SetIndexFilter(indexBuilder);
        }
    }
