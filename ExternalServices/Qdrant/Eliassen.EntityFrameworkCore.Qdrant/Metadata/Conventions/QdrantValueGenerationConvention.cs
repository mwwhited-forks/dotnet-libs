...
///     or were configured to use a <see cref="QdrantValueGenerationStrategy" />.
...
/// </remarks>
public class QdrantValueGenerationConvention : RelationalValueGenerationConvention
{
    /// <summary>
    ///     Creates a new instance of <see cref="QdrantValueGenerationConvention" />.
    /// </summary>
    /// <param name="dependencies">Parameter object containing dependencies for this convention.</param>
    /// <param name="relationalDependencies"> Parameter object containing relational dependencies for this convention.</param>
    public QdrantValueGenerationConvention(
    ...
    {
        if (name == QdrantAnnotationNames.ValueGenerationStrategy)
        {
    ...
    public override void ProcessEntityTypeAnnotationChanged(
        ...
        IConventionContext<IConventionAnnotation> context)
    {
        if (name is QdrantAnnotationNames.TemporalPeriodStartPropertyName or QdrantAnnotationNames.TemporalPeriodEndPropertyName
...
#pragma warning restore EF1001 // Internal EF Core API usage.
    ...
    public static new ValueGenerated? GetValueGenerated(IReadOnlyProperty property, in StoreObjectIdentifier storeObject)
        => RelationalValueGenerationConvention.GetValueGenerated(property, storeObject)
            ?? (property.GetValueGenerationStrategy(storeObject) != QdrantValueGenerationStrategy.None
    ...
    private static ValueGenerated? GetValueGenerated(
        ...
        => GetTemporalValueGenerated(property)
            ?? RelationalValueGenerationConvention.GetValueGenerated(property, storeObject)
            ?? (property.GetValueGenerationStrategy(storeObject, typeMappingSource) != QdrantValueGenerationStrategy.None
                ? ValueGenerated.OnAdd
                : null);
