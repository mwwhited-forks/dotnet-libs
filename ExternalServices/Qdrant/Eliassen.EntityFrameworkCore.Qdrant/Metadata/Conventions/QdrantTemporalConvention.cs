...
/// </remarks>
public class QdrantTemporalConvention : IEntityTypeAnnotationChangedConvention,
    ...
    IModelFinalizingConvention
{
    ...
    /// <summary>
    ///     Creates a new instance of <see cref="QdrantTemporalConvention" />.
    /// </summary>
    /// <param name="dependencies">Parameter object containing dependencies for this convention.</param>
    /// <param name="relationalDependencies">Parameter object containing relational dependencies for this convention.</param>
    public QdrantTemporalConvention(
    ...
    {
        if (name == QdrantAnnotationNames.IsTemporal)
        {
        ...
        if (name is QdrantAnnotationNames.TemporalPeriodStartPropertyName or QdrantAnnotationNames.TemporalPeriodEndPropertyName)
        {
            if (oldAnnotation?.Value is string oldPeriodPropertyName)
            {
                ...
                {
                    if ((name == QdrantAnnotationNames.TemporalPeriodStartPropertyName
                            && oldPeriodProperty.GetDefaultValue() is DateTime start
                            && start == DateTime.MinValue)
                        || (name == QdrantAnnotationNames.TemporalPeriodEndPropertyName
