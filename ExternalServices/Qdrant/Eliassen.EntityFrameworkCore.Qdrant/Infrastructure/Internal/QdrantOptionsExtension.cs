...
/// </summary>
public class QdrantOptionsExtension : RelationalOptionsExtension, IDbContextOptionsExtension
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected QdrantOptionsExtension(QdrantOptionsExtension copyFrom)
        : base(copyFrom)
    {
    ...
    protected override RelationalOptionsExtension Clone()
        => new QdrantOptionsExtension(this);
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual QdrantOptionsExtension WithCompatibilityLevel(int? compatibilityLevel)
    {
        var clone = (QdrantOptionsExtension)Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual QdrantOptionsExtension WithAzureSql(bool enable)
    {
        var clone = (QdrantOptionsExtension)Clone();
    ...
    public virtual IDbContextOptionsExtension ApplyDefaults(IDbContextOptions options)
    {
        ...
        {
            return WithExecutionStrategyFactory(c => new QdrantRetryingExecutionStrategy(c));
        }
    ...
    public override void ApplyServices(IServiceCollection services)
        => services.AddEntityFrameworkQdrant();
    ...
    private sealed class ExtensionInfo : RelationalExtensionInfo
    {
        ...
        private new QdrantOptionsExtension Extension
            => (QdrantOptionsExtension)base.Extension;
