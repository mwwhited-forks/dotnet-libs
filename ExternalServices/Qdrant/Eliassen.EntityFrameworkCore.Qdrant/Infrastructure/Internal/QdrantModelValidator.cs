...
/// </summary>
public class QdrantModelValidator : RelationalModelValidator
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
            ...
            foreach (var property in entityType.GetDeclaredProperties()
                         .Where(
                             p => p.ClrType.UnwrapNullableType() == typeof(byte)
                                 && p.GetValueGenerationStrategy() == QdrantValueGenerationStrategy.IdentityColumn))
            {
        ...
        IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
    {
        ...
        foreach (var entityType in model.GetEntityTypes())
        {
            foreach (var property in entityType.GetFlattenedDeclaredProperties())
            {
                ...
                if (strategy == QdrantValueGenerationStrategy.IdentityColumn
                    && !QdrantPropertyExtensions.IsCompatibleWithValueGeneration(property))
                {
                    throw new InvalidOperationException(
                        QdrantStrings.IdentityBadType(
                            property.Name, property.DeclaringType.DisplayName(), propertyType.ShortDisplayName()));
                }

                if (strategy is QdrantValueGenerationStrategy.SequenceHiLo or QdrantValueGenerationStrategy.Sequence
                    && !QdrantPropertyExtensions.IsCompatibleWithValueGeneration(property))
                {
                    throw new InvalidOperationException(
                        QdrantStrings.SequenceBadType(
                            property.Name, property.DeclaringType.DisplayName(), propertyType.ShortDisplayName()));
                }
            }
        }
        ...
        IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
    {
        foreach (var index in model.GetEntityTypes().SelectMany(t => t.GetDeclaredIndexes()))
        {
            ...
            if (includeProperties?.Count > 0)
            {
                ...
                {
                    throw new InvalidOperationException(
                        QdrantStrings.IncludePropertyNotFound(
                            notFound,
                            index.DisplayName(),
                ...
                {
                    throw new InvalidOperationException(
                        QdrantStrings.IncludePropertyDuplicated(
                            index.DeclaringEntityType.DisplayName(),
                            duplicateProperty,
                            index.DisplayName()));
                }
                ...
                {
                    throw new InvalidOperationException(
                        QdrantStrings.IncludePropertyInIndex(
                            index.DeclaringEntityType.DisplayName(),
                            coveredProperty,
                            index.DisplayName()));
                }
        ...
        IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
    {
        ...
        foreach (var temporalEntityType in temporalEntityTypes)
        {
            ...
            {
                throw new InvalidOperationException(QdrantStrings.TemporalOnlyOnRoot(temporalEntityType.DisplayName()));
            }
            ...
            {
                throw new InvalidOperationException(QdrantStrings.TemporalOnlySupportedForTPH(temporalEntityType.DisplayName()));
            }
        }
    }
    ...
    private static void ValidateTemporalPeriodProperty(IEntityType temporalEntityType, bool periodStart)
    {
        ...
        {
            throw new InvalidOperationException(
                QdrantStrings.TemporalMustDefinePeriodProperties(
        ...
        {
            throw new InvalidOperationException(
                QdrantStrings.TemporalExpectedPeriodPropertyNotFound(
        ...
        {
            throw new InvalidOperationException(
                QdrantStrings.TemporalPeriodPropertyMustBeInShadowState(
        ...
        {
            throw new InvalidOperationException(
                QdrantStrings.TemporalPeriodPropertyMustBeNonNullableDateTime(
        ...
        {
            throw new InvalidOperationException(
                QdrantStrings.TemporalPeriodPropertyMustBeMappedToDatetime2(
        ...
        {
            throw new InvalidOperationException(
                QdrantStrings.TemporalPeriodPropertyCantHaveDefaultValue(
                    temporalEntityType.DisplayName(), periodProperty.Name));
        }
        ...
        {
            throw new InvalidOperationException(
                QdrantStrings.TemporalPropertyMappedToPeriodColumnMustBeValueGeneratedOnAddOrUpdate(
        ...
        IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
    {
        ...
        foreach (var otherMappedType in mappedTypes.Skip(1))
        {
            ...
            {
                throw new InvalidOperationException(
                    QdrantStrings.IncompatibleTableMemoryOptimizedMismatch(
        ...
        foreach (var mappedType in mappedTypes)
        {
            ...
            {
                throw new InvalidOperationException(
                    QdrantStrings.IncompatibleSqlOutputClauseMismatch(
            ...
            && mappedTypes.Select(t => t.GetRootType()).Distinct().Count() > 1)
        {
            ...
            foreach (var mappedType in mappedTypes.Where(t => t.BaseType == null))
            {
                ...
                {
                    throw new InvalidOperationException(
                        QdrantStrings.TemporalAllEntitiesMappedToSameTableMustBeTemporal(
                ...
                {
                    throw new InvalidOperationException(
                        QdrantStrings.TemporalNotSupportedForTableSplittingWithInconsistentPeriodMapping(
                            "start",
                            mappedType.DisplayName(),
        ...
        IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
    {
        ...
        foreach (var property in mappedTypes.SelectMany(et => et.GetDeclaredProperties()))
        {
            ...
            if (property.GetValueGenerationStrategy(storeObject) == QdrantValueGenerationStrategy.IdentityColumn)
            {
        ...
        if (identityColumns.Count > 1)
        {
            ...
            throw new InvalidOperationException(QdrantStrings.MultipleIdentityColumns(sb, storeObject.DisplayName()));
        }
    }
        ...
        IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
    {
        ...
        if (propertyStrategy != duplicatePropertyStrategy)
        {
            var isConflicting = ((IConventionProperty)property)
                .FindAnnotation(QdrantAnnotationNames.ValueGenerationStrategy)
                ?.GetConfigurationSource()
                == ConfigurationSource.Explicit
                || propertyStrategy != QdrantValueGenerationStrategy.None;
            var isDuplicateConflicting = ((IConventionProperty)duplicateProperty)
                .FindAnnotation(QdrantAnnotationNames.ValueGenerationStrategy)
                ?.GetConfigurationSource()
                == ConfigurationSource.Explicit
                || duplicatePropertyStrategy != QdrantValueGenerationStrategy.None;

            if (isConflicting && isDuplicateConflicting)
            {
                throw new InvalidOperationException(
                    QdrantStrings.DuplicateColumnNameValueGenerationStrategyMismatch(
        ...
        else
        {
            switch (propertyStrategy)
            {
                case QdrantValueGenerationStrategy.IdentityColumn:
                    ...
                    {
                        throw new InvalidOperationException(
                            QdrantStrings.DuplicateColumnIdentityIncrementMismatch(
                                duplicateProperty.DeclaringType.DisplayName(),
                                duplicateProperty.Name,
                                property.DeclaringType.DisplayName(),
                                property.Name,
                    ...
                    {
                        throw new InvalidOperationException(
                            QdrantStrings.DuplicateColumnIdentitySeedMismatch(
                                duplicateProperty.DeclaringType.DisplayName(),
                                duplicateProperty.Name,
                                property.DeclaringType.DisplayName(),
                                property.Name,
                ...
                case QdrantValueGenerationStrategy.SequenceHiLo:
                    ...
                    {
                        throw new InvalidOperationException(
                            QdrantStrings.DuplicateColumnSequenceMismatch(
                                duplicateProperty.DeclaringType.DisplayName(),
                                duplicateProperty.Name,
                                property.DeclaringType.DisplayName(),
                                property.Name,
        ...
        {
            throw new InvalidOperationException(
                QdrantStrings.DuplicateColumnSparsenessMismatch(
                    duplicateProperty.DeclaringType.DisplayName(),
                    duplicateProperty.Name,
                    property.DeclaringType.DisplayName(),
                    property.Name,
        ...
        IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
    {
        ...
        key.AreCompatibleForQdrant(duplicateKey, storeObject, shouldThrow: true);
    }
        ...
        IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
    {
        ...
        index.AreCompatibleForQdrant(duplicateIndex, storeObject, shouldThrow: true);
    }
}
