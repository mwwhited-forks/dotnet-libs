...
namespace Eliassen.EntityFrameworkCore.Infrastructure;

/// <summary>
///     Allows SQL Server specific configuration to be performed on <see cref="DbContextOptions" />.
/// </summary>
/// <remarks>
///     Instances of this class are returned from a call to <see cref="O:QdrantDbContextOptionsExtensions.UseQdrant" />
///     and it is not designed to be directly constructed in your application code.
/// </remarks>
public class QdrantDbContextOptionsBuilder
    : RelationalDbContextOptionsBuilder<QdrantDbContextOptionsBuilder, QdrantOptionsExtension>
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="QdrantDbContextOptionsBuilder" /> class.
    /// </summary>
    /// <param name="optionsBuilder">The options builder.</param>
    public QdrantDbContextOptionsBuilder(DbContextOptionsBuilder optionsBuilder)
        : base(optionsBuilder)
    {
    }
    ...
    ///     </para>
    /// </remarks>
    public virtual QdrantDbContextOptionsBuilder EnableRetryOnFailure()
        => ExecutionStrategy(c => new QdrantRetryingExecutionStrategy(c));
    ...
    ///     </para>
    /// </remarks>
    public virtual QdrantDbContextOptionsBuilder EnableRetryOnFailure(int maxRetryCount)
        => ExecutionStrategy(c => new QdrantRetryingExecutionStrategy(c, maxRetryCount));
    ...
    public virtual QdrantDbContextOptionsBuilder EnableRetryOnFailure(ICollection<int> errorNumbersToAdd)
        => ExecutionStrategy(c => new QdrantRetryingExecutionStrategy(c, errorNumbersToAdd));
    ...
    public virtual QdrantDbContextOptionsBuilder EnableRetryOnFailure(
        ...
        => ExecutionStrategy(c => new QdrantRetryingExecutionStrategy(c, maxRetryCount, maxRetryDelay, errorNumbersToAdd));
    ...
    public virtual QdrantDbContextOptionsBuilder UseCompatibilityLevel(int compatibilityLevel)
    ...
    public virtual QdrantDbContextOptionsBuilder UseAzureSqlDefaults(bool enable = true)
