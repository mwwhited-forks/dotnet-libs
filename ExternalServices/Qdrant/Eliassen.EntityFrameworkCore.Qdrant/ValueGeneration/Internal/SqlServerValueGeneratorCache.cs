...
/// </summary>
public class QdrantValueGeneratorCache : ValueGeneratorCache, IQdrantValueGeneratorCache
{
    private readonly ConcurrentDictionary<string, QdrantSequenceValueGeneratorState> _sequenceGeneratorCache = new();

    /// <summary>
    ///     Initializes a new instance of the <see cref="ValueGeneratorCache" /> class.
    /// </summary>
    /// <param name="dependencies">Parameter object containing dependencies for this service.</param>
    public QdrantValueGeneratorCache(ValueGeneratorCacheDependencies dependencies)
        : base(dependencies)
    {
    }
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual QdrantSequenceValueGeneratorState GetOrAddSequenceState(
        IProperty property,
        IRelationalConnection connection)
    {
        ...
        return _sequenceGeneratorCache.GetOrAdd(
            ...
            _ => new QdrantSequenceValueGeneratorState(sequence));
    }
