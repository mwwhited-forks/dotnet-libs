...
///     </para>
/// </remarks>
public class QdrantOpenJsonExpression : TableValuedFunctionExpression
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantOpenJsonExpression(
        string alias,
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual QdrantOpenJsonExpression Update(
        SqlExpression jsonExpression,
        ...
        IReadOnlyList<ColumnInfo>? columnInfos = null)
    {
        ...
        return jsonExpression == JsonExpression
            ...
            && (ReferenceEquals(columnInfos, ColumnInfos)
                ...
                ? this
                : new QdrantOpenJsonExpression(Alias, jsonExpression, path, columnInfos);
    }
    ...
    public override TableExpressionBase Clone(string? alias, ExpressionVisitor cloningExpressionVisitor)
    {
        ...
        var clone = new QdrantOpenJsonExpression(alias!, newJsonExpression, Path, ColumnInfos);
    ...
    /// <inheritdoc />
    public override QdrantOpenJsonExpression WithAlias(string newAlias)
        => new(newAlias, JsonExpression, Path, ColumnInfos);

    /// <inheritdoc />
    public override Expression Quote()
        => New(
            _quotingConstructor ??= typeof(QdrantOpenJsonExpression).GetConstructor(
            [
                typeof(string),
    ...
    public override bool Equals(object? obj)
        => ReferenceEquals(this, obj) || (obj is QdrantOpenJsonExpression openJsonExpression && Equals(openJsonExpression));

    private bool Equals(QdrantOpenJsonExpression other)
    {
