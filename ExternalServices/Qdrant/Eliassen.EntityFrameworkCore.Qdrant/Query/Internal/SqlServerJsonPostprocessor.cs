...
using ColumnInfo = Microsoft.EntityFrameworkCore.Qdrant.Query.Internal.QdrantOpenJsonExpression.ColumnInfo;
...
///     1. Converts <see cref="QdrantOpenJsonExpression" /> expressions with WITH (the default) to OPENJSON without WITH under the
...
/// </remarks>
public sealed class QdrantJsonPostprocessor(
    ...
    : ExpressionVisitor
{
    ...
    public override Expression? Visit(Expression? expression)
    {
        switch (expression)
        {
            ...
            case SelectExpression selectExpression:
            {
                ...
                for (var i = 0; i < selectExpression.Tables.Count; i++)
                {
                    ...
                    if (table.UnwrapJoin() is QdrantOpenJsonExpression { ColumnInfos: { } columnInfos } openJsonExpression
                        ...
                        columnInfos.Any(c => c.TypeMapping.StoreType is "hierarchyid")))
                    {
                        ...
                        table = table switch
                        {
                            ...
                            QdrantOpenJsonExpression => newOpenJsonExpression,
        ...
        SqlExpression RewriteOpenJsonColumn(ColumnExpression columnExpression, ColumnInfo columnInfo)
        {
            ...
            // for base64 data.
            if (columnInfo.TypeMapping is QdrantByteArrayTypeMapping)
            {
                throw new InvalidOperationException(QdrantStrings.QueryingOrderedBinaryJsonCollectionsNotSupported);
            }
