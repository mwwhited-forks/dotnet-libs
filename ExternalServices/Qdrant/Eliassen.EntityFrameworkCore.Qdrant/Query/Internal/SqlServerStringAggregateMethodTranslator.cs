...
/// </summary>
public class QdrantStringAggregateMethodTranslator : IAggregateMethodCallTranslator
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantStringAggregateMethodTranslator(
        ...
        IDiagnosticsLogger<DbLoggerCategory.Query> logger)
    {
        ...
        return
            _sqlExpressionFactory.Coalesce(
                QdrantExpression.AggregateFunctionWithOrdering(
