...
/// </summary>
public class QdrantSqlTranslatingExpressionVisitor : RelationalSqlTranslatingExpressionVisitor
{
    ...
    private static readonly MethodInfo EscapeLikePatternParameterMethod =
        typeof(QdrantSqlTranslatingExpressionVisitor).GetTypeInfo().GetDeclaredMethod(nameof(ConstructLikePatternParameter))!;
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantSqlTranslatingExpressionVisitor(
