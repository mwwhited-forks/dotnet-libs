...
/// </summary>
public class QdrantDateTimeMethodTranslator : IMethodCallTranslator
{
    ...
    private static readonly MethodInfo AtTimeZoneDateTimeOffsetMethodInfo = typeof(QdrantDbFunctionsExtensions)
        .GetRuntimeMethod(
            nameof(QdrantDbFunctionsExtensions.AtTimeZone), [typeof(DbFunctions), typeof(DateTimeOffset), typeof(string)])!;

    private static readonly MethodInfo AtTimeZoneDateTimeMethodInfo = typeof(QdrantDbFunctionsExtensions)
        .GetRuntimeMethod(
            nameof(QdrantDbFunctionsExtensions.AtTimeZone), [typeof(DbFunctions), typeof(DateTime), typeof(string)])!;
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantDateTimeMethodTranslator(
