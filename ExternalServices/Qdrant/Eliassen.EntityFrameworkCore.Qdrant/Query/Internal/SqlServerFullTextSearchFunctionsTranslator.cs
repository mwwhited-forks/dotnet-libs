...
/// </summary>
public class QdrantFullTextSearchFunctionsTranslator : IMethodCallTranslator
{
    ...
    private static readonly MethodInfo FreeTextMethodInfo
        = typeof(QdrantDbFunctionsExtensions).GetRuntimeMethod(
            nameof(QdrantDbFunctionsExtensions.FreeText), [typeof(DbFunctions), typeof(object), typeof(string)])!;

    private static readonly MethodInfo FreeTextMethodInfoWithLanguage
        = typeof(QdrantDbFunctionsExtensions).GetRuntimeMethod(
            nameof(QdrantDbFunctionsExtensions.FreeText),
            [typeof(DbFunctions), typeof(object), typeof(string), typeof(int)])!;

    private static readonly MethodInfo ContainsMethodInfo
        = typeof(QdrantDbFunctionsExtensions).GetRuntimeMethod(
            nameof(QdrantDbFunctionsExtensions.Contains), [typeof(DbFunctions), typeof(object), typeof(string)])!;

    private static readonly MethodInfo ContainsMethodInfoWithLanguage
        = typeof(QdrantDbFunctionsExtensions).GetRuntimeMethod(
            nameof(QdrantDbFunctionsExtensions.Contains),
            [typeof(DbFunctions), typeof(object), typeof(string), typeof(int)])!;
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantFullTextSearchFunctionsTranslator(ISqlExpressionFactory sqlExpressionFactory)
    {
        ...
        IDiagnosticsLogger<DbLoggerCategory.Query> logger)
    {
        if (FunctionMapping.TryGetValue(method, out var functionName))
        {
            ...
            {
                throw new InvalidOperationException(QdrantStrings.InvalidColumnNameForFreeText);
            }
