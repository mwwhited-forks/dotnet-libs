...
/// </summary>
public class QdrantQueryableMethodTranslatingExpressionVisitorFactory : IQueryableMethodTranslatingExpressionVisitorFactory
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantQueryableMethodTranslatingExpressionVisitorFactory(
    ...
    public virtual QueryableMethodTranslatingExpressionVisitor Create(QueryCompilationContext queryCompilationContext)
        => new QdrantQueryableMethodTranslatingExpressionVisitor(
            Dependencies, RelationalDependencies, (QdrantQueryCompilationContext)queryCompilationContext, _QdrantSingletonOptions);
}
