...
/// </summary>
public class QdrantSqlNullabilityProcessor : SqlNullabilityProcessor
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantSqlNullabilityProcessor(
    ...
    protected override SqlExpression VisitCustomSqlExpression(
        ...
        {
            QdrantAggregateFunctionExpression aggregateFunctionExpression
                => VisitQdrantAggregateFunction(aggregateFunctionExpression, allowOptimizedExpansion, out nullable),
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual SqlExpression VisitQdrantAggregateFunction(
        QdrantAggregateFunctionExpression aggregateFunctionExpression,
        bool allowOptimizedExpansion,
        out bool nullable)
    {
...
#pragma warning disable EF1001
    ...
    {
        if (table is QdrantOpenJsonExpression { Arguments: [var argument] })
        {
            collection = argument;
            return true;
        }
    ...
    protected override TableExpressionBase UpdateParameterCollection(
        ...
        => table is QdrantOpenJsonExpression { Arguments: [SqlParameterExpression] } openJsonExpression
