...
/// </summary>
public class QdrantQueryableMethodTranslatingExpressionVisitor : RelationalQueryableMethodTranslatingExpressionVisitor
{
    private readonly QdrantQueryCompilationContext _queryCompilationContext;
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantQueryableMethodTranslatingExpressionVisitor(
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected QdrantQueryableMethodTranslatingExpressionVisitor(
        QdrantQueryableMethodTranslatingExpressionVisitor parentVisitor)
        : base(parentVisitor)
    {
        ...
        _QdrantCompatibilityLevel = parentVisitor._QdrantCompatibilityLevel;
    }
    ...
    protected override QueryableMethodTranslatingExpressionVisitor CreateSubqueryVisitor()
        => new QdrantQueryableMethodTranslatingExpressionVisitor(this);
        ...
        if (extensionExpression is TemporalQueryRootExpression queryRootExpression)
        {
            ...
            Func<TableExpression, TableExpressionBase> annotationApplyingFunc = queryRootExpression switch
            {
                TemporalAllQueryRootExpression => te => te
                    .AddAnnotation(QdrantAnnotationNames.TemporalOperationType, TemporalOperationType.All),
                TemporalAsOfQueryRootExpression asOf => te => te
                    .AddAnnotation(QdrantAnnotationNames.TemporalOperationType, TemporalOperationType.AsOf)
                    .AddAnnotation(QdrantAnnotationNames.TemporalAsOfPointInTime, asOf.PointInTime),
                TemporalBetweenQueryRootExpression between => te => te
                    .AddAnnotation(QdrantAnnotationNames.TemporalOperationType, TemporalOperationType.Between)
                    .AddAnnotation(QdrantAnnotationNames.TemporalRangeOperationFrom, between.From)
                    .AddAnnotation(QdrantAnnotationNames.TemporalRangeOperationTo, between.To),
                TemporalContainedInQueryRootExpression containedIn => te => te
                    .AddAnnotation(QdrantAnnotationNames.TemporalOperationType, TemporalOperationType.ContainedIn)
                    .AddAnnotation(QdrantAnnotationNames.TemporalRangeOperationFrom, containedIn.From)
                    .AddAnnotation(QdrantAnnotationNames.TemporalRangeOperationTo, containedIn.To),
                TemporalFromToQueryRootExpression fromTo => te => te
                    .AddAnnotation(QdrantAnnotationNames.TemporalOperationType, TemporalOperationType.FromTo)
                    .AddAnnotation(QdrantAnnotationNames.TemporalRangeOperationFrom, fromTo.From)
                    .AddAnnotation(QdrantAnnotationNames.TemporalRangeOperationTo, fromTo.To),
    ...
    protected override ShapedQueryExpression? TranslatePrimitiveCollection(
        ...
        string tableAlias)
    {
        if (_QdrantCompatibilityLevel < 130)
        {
            AddTranslationErrorDetails(QdrantStrings.CompatibilityLevelTooLowForScalarCollections(_QdrantCompatibilityLevel));
        ...
        // QdrantInferredTypeMappingApplier below), at which point the we'll apply it to add the WITH clause.
        ...
        var openJsonExpression = elementTypeMapping is null
            ? new QdrantOpenJsonExpression(tableAlias, sqlExpression)
            : new QdrantOpenJsonExpression(
                tableAlias, sqlExpression,
                columnInfos: new[]
                {
                    new QdrantOpenJsonExpression.ColumnInfo
                    {
                        Name = "value",
...
#pragma warning restore EF1001 // Internal EF Core API usage.
        ...
        // In QdrantQueryTranslationPostprocessor, we'll post-process the expression; if the ORDER BY was stripped (e.g. because of
    ...
    protected override ShapedQueryExpression TransformJsonQueryToTable(JsonQueryExpression jsonQueryExpression)
    {
        ...
        var columnInfos = new List<QdrantOpenJsonExpression.ColumnInfo>();
        ...
        var openJsonExpression = new QdrantOpenJsonExpression(
    ...
    protected override ShapedQueryExpression? TranslateContains(ShapedQueryExpression source, Expression item)
    {
        ...
        if (_queryCompilationContext.InAggregateFunction
            ...
            && projection is InExpression
            {
                ...
                Subquery:
                {
                    Tables: [QdrantOpenJsonExpression { Arguments: [SqlParameterExpression parameter] } openJsonExpression],
                    GroupBy: [],
                    Having: null,
                    IsDistinct: false,
                    Limit: null,
...
#pragma warning restore EF1001
        ...
        bool returnDefault)
    {
        ...
        if (!returnDefault
            ...
            {
                Tables: [QdrantOpenJsonExpression { Arguments: [var jsonArrayColumn] } openJsonExpression],
                GroupBy: [],
                Having: null,
                IsDistinct: false,
                Limit: null,
...
#pragma warning restore EF1001
    ...
    protected override bool IsNaturallyOrdered(SelectExpression selectExpression)
        => selectExpression is
            {
                Tables: [QdrantOpenJsonExpression openJsonExpression, ..],
                Orderings:
                [
                    {
                        Expression: SqlUnaryExpression
