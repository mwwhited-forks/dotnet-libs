...
/// </remarks>
public static class QdrantIndexBuilderExtensions
{
    /// <summary>
    ...
    public static bool CanSetIsClustered(
        ...
        bool? clustered,
        bool fromDataAnnotation = false)
        => indexBuilder.CanSetAnnotation(QdrantAnnotationNames.Clustered, clustered, fromDataAnnotation);
    ...
    public static bool CanSetIsCreatedOnline(
        ...
        bool? createdOnline,
        bool fromDataAnnotation = false)
        => indexBuilder.CanSetAnnotation(QdrantAnnotationNames.CreatedOnline, createdOnline, fromDataAnnotation);
    ...
    public static bool CanSetFillFactor(
        ...
        int? fillFactor,
        bool fromDataAnnotation = false)
        => indexBuilder.CanSetAnnotation(QdrantAnnotationNames.FillFactor, fillFactor, fromDataAnnotation);
    ...
    public static bool CanSetSortInTempDb(
        ...
        bool? sortInTempDb,
        bool fromDataAnnotation = false)
        => indexBuilder.CanSetAnnotation(QdrantAnnotationNames.SortInTempDb, sortInTempDb, fromDataAnnotation);
    ...
    public static bool CanSetDataCompression(
        ...
        DataCompressionType? dataCompressionType,
        bool fromDataAnnotation = false)
        => indexBuilder.CanSetAnnotation(QdrantAnnotationNames.DataCompression, dataCompressionType, fromDataAnnotation);
}
