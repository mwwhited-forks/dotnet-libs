...
/// </remarks>
public static class QdrantKeyBuilderExtensions
{
    /// <summary>
    ...
    public static bool CanSetIsClustered(
        ...
        bool? clustered,
        bool fromDataAnnotation = false)
        => keyBuilder.CanSetAnnotation(QdrantAnnotationNames.Clustered, clustered, fromDataAnnotation);
    ...
    public static bool CanSetFillFactor(
        ...
        int? fillFactor,
        bool fromDataAnnotation = false)
        => keyBuilder.CanSetAnnotation(QdrantAnnotationNames.FillFactor, fillFactor, fromDataAnnotation);
}
