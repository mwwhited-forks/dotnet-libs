...
/// </remarks>
public static class QdrantPropertyBuilderExtensions
{
    /// <summary>
    ...
    public static bool CanSetHiLoSequence(
        ...
        bool fromDataAnnotation = false)
    {
        return propertyBuilder.CanSetAnnotation(QdrantAnnotationNames.HiLoSequenceName, name, fromDataAnnotation)
            && propertyBuilder.CanSetAnnotation(QdrantAnnotationNames.HiLoSequenceSchema, schema, fromDataAnnotation);
    }
    ...
    public static bool CanSetSequence(
        ...
        bool fromDataAnnotation = false)
    {
        return propertyBuilder.CanSetAnnotation(QdrantAnnotationNames.SequenceName, name, fromDataAnnotation)
            && propertyBuilder.CanSetAnnotation(QdrantAnnotationNames.SequenceSchema, schema, fromDataAnnotation);
    }
        ...
        int increment = 1)
    {
        ...
        overrides.SetValueGenerationStrategy(QdrantValueGenerationStrategy.IdentityColumn);
    ...
    public static bool CanSetIdentityColumnSeed(
        ...
        long? seed,
        bool fromDataAnnotation = false)
        => propertyBuilder.CanSetAnnotation(QdrantAnnotationNames.IdentitySeed, seed, fromDataAnnotation);
    ...
    public static bool CanSetIdentityColumnIncrement(
        ...
        int? increment,
        bool fromDataAnnotation = false)
        => propertyBuilder.CanSetAnnotation(QdrantAnnotationNames.IdentityIncrement, increment, fromDataAnnotation);
    ...
    public static bool CanSetIsSparse(
        ...
        bool? sparse,
        bool fromDataAnnotation = false)
        => property.CanSetAnnotation(QdrantAnnotationNames.Sparse, sparse, fromDataAnnotation);
}
