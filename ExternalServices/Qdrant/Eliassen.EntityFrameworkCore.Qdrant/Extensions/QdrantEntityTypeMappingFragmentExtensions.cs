...
/// </summary>
public static class QdrantEntityTypeMappingFragmentExtensions
{
    /// <summary>
    ...
    public static bool IsSqlOutputClauseUsed(this IReadOnlyEntityTypeMappingFragment fragment)
        => fragment.FindAnnotation(QdrantAnnotationNames.UseSqlOutputClause) is not { Value: false };
    ...
    public static void UseSqlOutputClause(this IMutableEntityTypeMappingFragment fragment, bool? useSqlOutputClause)
        => fragment.SetAnnotation(QdrantAnnotationNames.UseSqlOutputClause, useSqlOutputClause);
    ...
    public static bool? UseSqlOutputClause(
        ...
        => (bool?)fragment.SetAnnotation(QdrantAnnotationNames.UseSqlOutputClause, useSqlOutputClause, fromDataAnnotation)?.Value;
    ...
    public static ConfigurationSource? GetUseSqlOutputClauseConfigurationSource(this IConventionEntityTypeMappingFragment fragment)
        => fragment.FindAnnotation(QdrantAnnotationNames.UseSqlOutputClause)?.GetConfigurationSource();
}
