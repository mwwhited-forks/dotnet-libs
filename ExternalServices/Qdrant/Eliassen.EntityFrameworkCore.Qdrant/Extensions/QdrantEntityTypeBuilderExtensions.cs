...
/// </remarks>
public static class QdrantEntityTypeBuilderExtensions
{
    /// <summary>
    ...
    public static bool CanSetIsMemoryOptimized(
        ...
        bool? memoryOptimized,
        bool fromDataAnnotation = false)
        => entityTypeBuilder.CanSetAnnotation(QdrantAnnotationNames.MemoryOptimized, memoryOptimized, fromDataAnnotation);
    ...
    public static bool CanSetIsTemporal(
        ...
        bool temporal = true,
        bool fromDataAnnotation = false)
        => entityTypeBuilder.CanSetAnnotation(QdrantAnnotationNames.IsTemporal, temporal, fromDataAnnotation);
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return entityTypeBuilder.CanSetAnnotation(QdrantAnnotationNames.TemporalHistoryTableName, name, fromDataAnnotation);
    }
    ...
    public static bool CanSetHistoryTableSchema(
        ...
        string? schema,
        bool fromDataAnnotation = false)
        => entityTypeBuilder.CanSetAnnotation(QdrantAnnotationNames.TemporalHistoryTableSchema, schema, fromDataAnnotation);
    ...
    public static bool CanSetPeriodStart(
        ...
        => entityTypeBuilder.CanSetAnnotation(
            QdrantAnnotationNames.TemporalPeriodStartPropertyName, propertyName, fromDataAnnotation);
    ...
    public static bool CanSetPeriodEnd(
        ...
        bool fromDataAnnotation = false)
        => entityTypeBuilder.CanSetAnnotation(
            QdrantAnnotationNames.TemporalPeriodEndPropertyName, propertyName, fromDataAnnotation);
}
