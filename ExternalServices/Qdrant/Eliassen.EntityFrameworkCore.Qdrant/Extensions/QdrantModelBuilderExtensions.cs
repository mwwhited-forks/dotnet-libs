...
/// </remarks>
public static class QdrantModelBuilderExtensions
{
    /// <summary>
        ...
        string? schema = null)
    {
        ...
        model.SetValueGenerationStrategy(QdrantValueGenerationStrategy.SequenceHiLo);
    ...
    public static bool CanSetHiLoSequence(
        ...
        bool fromDataAnnotation = false)
    {
        return modelBuilder.CanSetAnnotation(QdrantAnnotationNames.HiLoSequenceName, name, fromDataAnnotation)
            && modelBuilder.CanSetAnnotation(QdrantAnnotationNames.HiLoSequenceSchema, schema, fromDataAnnotation);
    }
        ...
        string? schema = null)
    {
        ...
        nameSuffix ??= QdrantModelExtensions.DefaultSequenceNameSuffix;

        model.SetValueGenerationStrategy(QdrantValueGenerationStrategy.Sequence);
        ...
        int increment = 1)
    {
        ...
        model.SetValueGenerationStrategy(QdrantValueGenerationStrategy.IdentityColumn);
    ...
    public static bool CanSetIdentityColumnSeed(
        ...
        long? seed,
        bool fromDataAnnotation = false)
        => modelBuilder.CanSetAnnotation(QdrantAnnotationNames.IdentitySeed, seed, fromDataAnnotation);
    ...
    public static bool CanSetIdentityColumnIncrement(
        ...
        int? increment,
        bool fromDataAnnotation = false)
        => modelBuilder.CanSetAnnotation(QdrantAnnotationNames.IdentityIncrement, increment, fromDataAnnotation);
    ...
    public static IConventionModelBuilder? HasValueGenerationStrategy(
        this IConventionModelBuilder modelBuilder,
        QdrantValueGenerationStrategy? valueGenerationStrategy,
        bool fromDataAnnotation = false)
    {
        if (modelBuilder.CanSetValueGenerationStrategy(valueGenerationStrategy, fromDataAnnotation))
        {
            ...
            if (valueGenerationStrategy != QdrantValueGenerationStrategy.IdentityColumn)
            {
            ...
            if (valueGenerationStrategy != QdrantValueGenerationStrategy.SequenceHiLo)
            {
                modelBuilder.HasHiLoSequence(null, null, fromDataAnnotation);
            }

            if (valueGenerationStrategy != QdrantValueGenerationStrategy.Sequence)
            {
        ...
        {
            if (modelBuilder.CanSetAnnotation(QdrantAnnotationNames.SequenceNameSuffix, null)
                && modelBuilder.CanSetAnnotation(QdrantAnnotationNames.SequenceSchema, null))
            {
    ...
    public static bool CanSetValueGenerationStrategy(
        ...
        => modelBuilder.CanSetAnnotation(
            QdrantAnnotationNames.ValueGenerationStrategy, valueGenerationStrategy, fromDataAnnotation);
    ...
    public static bool CanSetDatabaseMaxSize(
        ...
        string? maxSize,
        bool fromDataAnnotation = false)
        => modelBuilder.CanSetAnnotation(QdrantAnnotationNames.MaxDatabaseSize, maxSize, fromDataAnnotation);
    ...
    public static bool CanSetServiceTierSql(
        ...
        string? serviceTier,
        bool fromDataAnnotation = false)
        => modelBuilder.CanSetAnnotation(QdrantAnnotationNames.ServiceTierSql, serviceTier, fromDataAnnotation);
    ...
    public static bool CanSetPerformanceLevelSql(
        ...
        string? performanceLevel,
        bool fromDataAnnotation = false)
        => modelBuilder.CanSetAnnotation(QdrantAnnotationNames.PerformanceLevelSql, performanceLevel, fromDataAnnotation);
}
