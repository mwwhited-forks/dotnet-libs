...
namespace Eliassen.EntityFrameworkCore.Qdrant.Internal
{
    /// <summary>
    ...
    /// </summary>
    public static class QdrantStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Microsoft.EntityFrameworkCore.Qdrant.Properties.QdrantStrings", typeof(QdrantStrings).Assembly);
        ...
        /// <summary>
        ///     Could not save changes because the target table has computed column with a function that performs data access. Please configure your table accordingly, see https://aka.ms/efcore-docs-Qdrant-save-changes-and-output-clause for more information.
        /// </summary>
        ...
        /// <summary>
        ///     Could not save changes because the target table has database triggers. Please configure your table accordingly, see https://aka.ms/efcore-docs-Qdrant-save-changes-and-output-clause for more information.
        /// </summary>
        ...
        /// <summary>
        ///     An exception has been raised that is likely due to a transient failure. Consider enabling transient error resiliency by adding 'EnableRetryOnFailure' to the 'UseQdrant' call.
        /// </summary>
...
namespace Eliassen.EntityFrameworkCore.Qdrant.Internal
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static class QdrantResources
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Microsoft.EntityFrameworkCore.Qdrant.Properties.QdrantStrings", typeof(QdrantResources).Assembly);
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogByteIdentityColumn;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogByteIdentityColumn,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        QdrantEventId.ByteIdentityColumnWarning,
                        LogLevel.Warning,
                        "QdrantEventId.ByteIdentityColumnWarning",
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogColumnWithoutType;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogColumnWithoutType,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        QdrantEventId.ColumnWithoutTypeWarning,
                        LogLevel.Warning,
                        "QdrantEventId.ColumnWithoutTypeWarning",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        /// <summary>
        ///     Both the QdrantValueGenerationStrategy '{generationStrategy}' and '{otherGenerationStrategy}' have been set on property '{propertyName}' on entity type '{entityName}'. Configuring two strategies is usually unintentional and will likely result in a database error.
        /// </summary>
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogConflictingValueGenerationStrategies;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogConflictingValueGenerationStrategies,
                    logger,
                    static logger => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        QdrantEventId.ConflictingValueGenerationStrategiesWarning,
                        LogLevel.Warning,
                        "QdrantEventId.ConflictingValueGenerationStrategiesWarning",
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogDecimalTypeKey;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogDecimalTypeKey,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        QdrantEventId.DecimalTypeKeyWarning,
                        LogLevel.Warning,
                        "QdrantEventId.DecimalTypeKeyWarning",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogDefaultDecimalTypeColumn;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogDefaultDecimalTypeColumn,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        QdrantEventId.DecimalTypeDefaultWarning,
                        LogLevel.Warning,
                        "QdrantEventId.DecimalTypeDefaultWarning",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogDuplicateForeignKeyConstraintIgnored;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogDuplicateForeignKeyConstraintIgnored,
                    logger,
                    static logger => new EventDefinition<string, string, string>(
                        logger.Options,
                        QdrantEventId.DuplicateForeignKeyConstraintIgnored,
                        LogLevel.Warning,
                        "QdrantEventId.DuplicateForeignKeyConstraintIgnored",
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundColumn;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundColumn,
                    logger,
                    static logger => new FallbackEventDefinition(
                        logger.Options,
                        QdrantEventId.ColumnFound,
                        LogLevel.Debug,
                        "QdrantEventId.ColumnFound",
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundDefaultSchema;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundDefaultSchema,
                    logger,
                    static logger => new EventDefinition<string>(
                        logger.Options,
                        QdrantEventId.DefaultSchemaFound,
                        LogLevel.Debug,
                        "QdrantEventId.DefaultSchemaFound",
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundForeignKey;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundForeignKey,
                    logger,
                    static logger => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        QdrantEventId.ForeignKeyFound,
                        LogLevel.Debug,
                        "QdrantEventId.ForeignKeyFound",
                        level => LoggerMessage.Define<string, string, string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundIndex;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundIndex,
                    logger,
                    static logger => new EventDefinition<string, string, bool>(
                        logger.Options,
                        QdrantEventId.IndexFound,
                        LogLevel.Debug,
                        "QdrantEventId.IndexFound",
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundPrimaryKey;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundPrimaryKey,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        QdrantEventId.PrimaryKeyFound,
                        LogLevel.Debug,
                        "QdrantEventId.PrimaryKeyFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundSequence;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundSequence,
                    logger,
                    static logger => new FallbackEventDefinition(
                        logger.Options,
                        QdrantEventId.SequenceFound,
                        LogLevel.Debug,
                        "QdrantEventId.SequenceFound",
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundTable;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundTable,
                    logger,
                    static logger => new EventDefinition<string>(
                        logger.Options,
                        QdrantEventId.TableFound,
                        LogLevel.Debug,
                        "QdrantEventId.TableFound",
                        level => LoggerMessage.Define<string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundTypeAlias;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundTypeAlias,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        QdrantEventId.TypeAliasFound,
                        LogLevel.Debug,
                        "QdrantEventId.TypeAliasFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundUniqueConstraint;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogFoundUniqueConstraint,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        QdrantEventId.UniqueConstraintFound,
                        LogLevel.Debug,
                        "QdrantEventId.UniqueConstraintFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogMissingSchema;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogMissingSchema,
                    logger,
                    static logger => new EventDefinition<string?>(
                        logger.Options,
                        QdrantEventId.MissingSchemaWarning,
                        LogLevel.Warning,
                        "QdrantEventId.MissingSchemaWarning",
                        level => LoggerMessage.Define<string?>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogMissingTable;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogMissingTable,
                    logger,
                    static logger => new EventDefinition<string?>(
                        logger.Options,
                        QdrantEventId.MissingTableWarning,
                        LogLevel.Warning,
                        "QdrantEventId.MissingTableWarning",
                        level => LoggerMessage.Define<string?>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogMissingViewDefinitionRights;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogMissingViewDefinitionRights,
                    logger,
                    static logger => new EventDefinition(
                        logger.Options,
                        QdrantEventId.MissingViewDefinitionRightsWarning,
                        LogLevel.Warning,
                        "QdrantEventId.MissingViewDefinitionRightsWarning",
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogPrincipalColumnNotFound;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogPrincipalColumnNotFound,
                    logger,
                    static logger => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        QdrantEventId.ForeignKeyPrincipalColumnMissingWarning,
                        LogLevel.Warning,
                        "QdrantEventId.ForeignKeyPrincipalColumnMissingWarning",
                        level => LoggerMessage.Define<string, string, string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogPrincipalTableInformationNotFound;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogPrincipalTableInformationNotFound,
                    logger,
                    static logger => new EventDefinition<string?, string?>(
                        logger.Options,
                        QdrantEventId.ForeignKeyReferencesUnknownPrincipalTableWarning,
                        LogLevel.Warning,
                        "QdrantEventId.ForeignKeyReferencesUnknownPrincipalTableWarning",
                        level => LoggerMessage.Define<string?, string?>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogPrincipalTableNotInSelectionSet;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogPrincipalTableNotInSelectionSet,
                    logger,
                    static logger => new EventDefinition<string?, string?, string?>(
                        logger.Options,
                        QdrantEventId.ForeignKeyReferencesMissingPrincipalTableWarning,
                        LogLevel.Warning,
                        "QdrantEventId.ForeignKeyReferencesMissingPrincipalTableWarning",
                        level => LoggerMessage.Define<string?, string?, string?>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogReflexiveConstraintIgnored;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogReflexiveConstraintIgnored,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        QdrantEventId.ReflexiveConstraintIgnored,
                        LogLevel.Debug,
                        "QdrantEventId.ReflexiveConstraintIgnored",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        /// <summary>
        ///     Savepoints are disabled because Multiple Active Result Sets (MARS) is enabled. If 'SaveChanges' fails, then the transaction cannot be automatically rolled back to a known clean state. Instead, the transaction should be rolled back by the application before retrying 'SaveChanges'. See https://go.microsoft.com/fwlink/?linkid=2149338 for more information and examples. To identify the code which triggers this warning, call 'ConfigureWarnings(w =&gt; w.Throw(QdrantEventId.SavepointsDisabledBecauseOfMARS))'.
        /// </summary>
        public static EventDefinition LogSavepointsDisabledBecauseOfMARS(IDiagnosticsLogger logger)
        {
            var definition = ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogSavepointsDisabledBecauseOfMARS;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.QdrantLoggingDefinitions)logger.Definitions).LogSavepointsDisabledBecauseOfMARS,
                    logger,
                    static logger => new EventDefinition(
                        logger.Options,
                        QdrantEventId.SavepointsDisabledBecauseOfMARS,
                        LogLevel.Warning,
                        "QdrantEventId.SavepointsDisabledBecauseOfMARS",
                        level => LoggerMessage.Define(
                            level,
