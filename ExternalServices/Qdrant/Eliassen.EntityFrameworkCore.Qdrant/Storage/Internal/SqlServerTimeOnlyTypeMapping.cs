...
/// </summary>
public class QdrantTimeOnlyTypeMapping : TimeOnlyTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static new QdrantTimeOnlyTypeMapping Default { get; } = new("time");

    internal QdrantTimeOnlyTypeMapping(string storeType, StoreTypePostfix storeTypePostfix = StoreTypePostfix.Precision)
        : base(
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected QdrantTimeOnlyTypeMapping(RelationalTypeMappingParameters parameters)
        : base(parameters)
    {
    }
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new QdrantTimeOnlyTypeMapping(parameters);
