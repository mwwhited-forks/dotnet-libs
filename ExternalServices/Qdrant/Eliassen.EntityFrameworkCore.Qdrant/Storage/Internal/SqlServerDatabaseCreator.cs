...
/// </summary>
public class QdrantDatabaseCreator : RelationalDatabaseCreator
{
...
SELECT 1 ELSE SELECT 0");
    ...
    private IReadOnlyList<MigrationCommand> CreateCreateOperations()
    {
        ...
        return Dependencies.MigrationsSqlGenerator.Generate(
            new[]
            {
                new QdrantCreateDatabaseOperation
                {
    ...
    private IReadOnlyList<MigrationCommand> CreateDropCommands()
    {
        ...
        {
            throw new InvalidOperationException(QdrantStrings.NoInitialCatalog);
        }

        var operations = new MigrationOperation[] { new QdrantDropDatabaseOperation { Name = databaseName } };
