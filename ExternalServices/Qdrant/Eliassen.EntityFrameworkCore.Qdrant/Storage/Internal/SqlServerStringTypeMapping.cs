...
/// </summary>
public class QdrantStringTypeMapping : StringTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static new QdrantStringTypeMapping Default { get; } = new();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantStringTypeMapping(
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected QdrantStringTypeMapping(RelationalTypeMappingParameters parameters, SqlDbType? sqlDbType)
        : base(parameters)
    {
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
    {
        ...
        return new QdrantStringTypeMapping(parameters, _sqlDbType);
    }
