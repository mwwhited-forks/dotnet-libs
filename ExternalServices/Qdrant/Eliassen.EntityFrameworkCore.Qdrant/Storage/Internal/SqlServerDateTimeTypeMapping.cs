...
/// </summary>
public class QdrantDateTimeTypeMapping : DateTimeTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static new QdrantDateTimeTypeMapping Default { get; } = new("datetime2");
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantDateTimeTypeMapping(
        string storeType,
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected QdrantDateTimeTypeMapping(RelationalTypeMappingParameters parameters, SqlDbType? sqlDbType)
        : base(parameters)
    {
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new QdrantDateTimeTypeMapping(parameters, _sqlDbType);
