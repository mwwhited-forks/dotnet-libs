...
/// </summary>
public class QdrantConnection : RelationalConnection, IQdrantConnection
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantConnection(RelationalConnectionDependencies dependencies)
        : base(dependencies)
    {
    }
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual IQdrantConnection CreateMasterConnection()
    {
        ...
        return new QdrantConnection(Dependencies with { ContextOptions = contextOptions });
    }
