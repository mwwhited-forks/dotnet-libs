...
/// </summary>
public class QdrantDateTimeOffsetTypeMapping : DateTimeOffsetTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static new QdrantDateTimeOffsetTypeMapping Default { get; } = new("datetimeoffset");
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantDateTimeOffsetTypeMapping(
        string storeType,
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected QdrantDateTimeOffsetTypeMapping(RelationalTypeMappingParameters parameters)
        : base(parameters)
    {
    }
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new QdrantDateTimeOffsetTypeMapping(parameters);
