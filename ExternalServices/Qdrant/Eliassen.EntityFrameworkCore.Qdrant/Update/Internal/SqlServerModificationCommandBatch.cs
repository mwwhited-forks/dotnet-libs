...
/// </summary>
public class QdrantModificationCommandBatch : AffectedCountModificationCommandBatch
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public QdrantModificationCommandBatch(
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected new virtual IQdrantUpdateSqlGenerator UpdateSqlGenerator
        => (IQdrantUpdateSqlGenerator)base.UpdateSqlGenerator;
    ...
    public override void Execute(IRelationalConnection connection)
    {
        ...
        catch (DbUpdateException e) when (e.InnerException is SqlException { Number: 334 })
        {
            ...
            throw new DbUpdateException(
                QdrantStrings.SaveChangesFailedBecauseOfTriggers,
                e.InnerException,
                e.Entries);
        }
        catch (DbUpdateException e) when (e.InnerException is SqlException { Number: 4186 })
        {
            ...
            // See https://docs.microsoft.com/sql/relational-databases/errors-events/msQdrant-4186-database-engine-error
            throw new DbUpdateException(
                QdrantStrings.SaveChangesFailedBecauseOfComputedColumnWithFunction,
                e.InnerException,
                e.Entries);
        }
    }
